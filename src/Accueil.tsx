    ...
    <div className="bg-white overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white min-h-[90vh]">
        <div className="container mx-auto px-6 h-full">
          <div className="grid md:grid-cols-2 gap-12 items-start md:items-center min-h-[90vh] pt-8 md:pt-0">
            ...
            >
              <div className="space-y-4">
                <p className="text-red-400 uppercase tracking-widest text-xs md:text-sm font-semibold">
                ...
                <p className="text-gray-300 text-sm md:text-lg max-w-lg leading-relaxed">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center bg-white text-black px-6 py-3 md:px-8 md:py-4 text-xs md:text-base font-semibold tracking-wider hover:bg-gray-100 transition-all transform hover:scale-105 group"
              >
          ...
          {/* Social Icons */}
          <div className="absolute left-6 bottom-12 hidden md:flex space-x-6 z-20">
            {[
      ...
      <div className="bg-black text-white py-6 overflow-hidden border-t border-gray-800">
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span key={i} className="text-sm md:text-2xl font-light tracking-[0.2em] mx-4 md:mx-8">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            <motion.div 
              ...
              className="md:w-1/2"
            >
              <span className="text-xs md:text-sm font-bold tracking-widest text-gray-400 uppercase mb-4 block">Notre Philosophie</span>
              <h2 className="text-3xl md:text-6xl font-serif font-medium mb-6 md:mb-8 leading-tight text-gray-900">
                L'Art du <br/>
              ...
              <Link 
                to="/shop" 
                className="inline-block border-b border-black pb-1 text-black hover:text-gray-600 hover:border-gray-600 transition-all tracking-widest text-xs md:text-sm"
              >
                DÉCOUVRIR L'ATELIER
              </Link>
            </motion.div>
      ...
      <section className="py-12 md:py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center mb-8 md:mb-16">
            <h3 className="text-xl md:text-2xl font-light uppercase tracking-[0.3em] text-center mb-4">Sélection Exclusive</h3>
              ...
              {regularProducts.map((product) => (
                <SwiperSlide key={product.id}>
                  <div className="group cursor-pointer">
                    <div className="relative overflow-hidden aspect-[3/4] mb-4 md:mb-6 bg-gray-200">
                      <img 
                        src={product.image} 
                        alt={product.name} 
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                        <Link 
                          to="/shop"
                          className="bg-white text-black px-6 py-2 md:px-8 md:py-3 text-[10px] md:text-xs font-bold tracking-widest hover:bg-black hover:text-white transition-colors transform translate-y-4 group-hover:translate-y-0 duration-500"
                        >
                          VOIR LE PRODUIT
                        </Link>
                      </div>
          ...
          <div className="text-center mt-8 md:mt-16">
            <Link 
              to="/shop" 
              className="inline-block border border-black px-8 py-3 md:px-10 md:py-4 text-xs md:text-sm font-bold tracking-widest hover:bg-black hover:text-white transition-all duration-300"
            >
              TOUTE LA COLLECTION
            </Link>
          </div>
      ...
      <section className="flex flex-col md:grid md:grid-cols-2 md:h-[70vh] md:min-h-[500px]">
        <div className="relative group overflow-hidden h-[300px] md:h-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 text-center">
            <h3 className="text-2xl md:text-5xl font-serif italic mb-2 md:mb-4 transform translate-y-0 group-hover:-translate-y-2 transition-transform duration-500">Sur Mesure</h3>
            <p className="max-w-md text-gray-200 text-sm md:text-base mb-6 md:mb-8 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100">
              Des créations uniques adaptées à votre morphologie et à vos envies.
            </p>
            <Link to="/shop" className="border-b border-white pb-1 tracking-widest text-xs md:text-sm hover:text-gray-300 hover:border-gray-300 transition-colors">
              EXPLORER
            </Link>
          </div>
        </div>
        ...
        <div className="relative group overflow-hidden h-[300px] md:h-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-8 text-center">
            <h3 className="text-2xl md:text-5xl font-serif italic mb-2 md:mb-4 transform translate-y-0 group-hover:-translate-y-2 transition-transform duration-500">Prêt-à-porter</h3>
            <p className="max-w-md text-gray-200 text-sm md:text-base mb-6 md:mb-8 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100">
      ...
      <section className="hidden md:block py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6">
