...
import { FiMail, FiLock, FiEye, FiEyeOff, FiPhone, FiArrowLeft, FiUser } from "react-icons/fi";
...
const Register: FC = () => {
  ...
  return (
    <div className="h-screen flex overflow-hidden">
      {/* Left Side - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 bg-white h-full overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-600 text-sm">Créez votre compte</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                    placeholder="Jean"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
      ...
      {/* Right Side - Image */}
      <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            <h2 className="text-5xl font-bold mb-6">Rejoignez HAR DESIGN</h2>
            ...
            <div className="space-y-4 mt-12 text-left max-w-md mx-auto">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Livraison possible</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Accédez aux ventes privées</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-white bg-opacity-10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Suivez vos achats en temps réel</p>
                </div>
              </div>
            </div>
          </div>
