        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm text-gray-900 hover:underline font-medium">
                Mot de passe oublié ?
              </Link>
            </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            <h2 className="text-5xl font-bold mb-6">Bienvenue chez HAR DESIGN</h2>
            <p className="text-xl text-gray-300 mb-8">
              Découvrez notre collection exclusive de mode et accessoires
            </p>
            <div className="flex justify-center gap-8 mt-12">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-400">Marques</div>
              </div>
            </div>
          </div>
        </div>
